...
export const metadata: Metadata = {
  title: "AI 課程｜GEO・AI 網站建立・AI Marketing｜未來方針教育中心",
  description:
    "未來方針教育中心提供 GEO 證書課程、AI 網站建立及 AI Marketing 實戰課程，面向中小企、Marketing 從業員及創業者。",
};
            ...
            {courses.map((course) => (
              ...
              >
                <div className="relative h-52">
                  <Image src={course.cover} alt={course.title} fill sizes="(min-width: 768px) 33vw, 100vw" className="object-cover" />
                </div>
                <div className="p-6">
                  ...
                  <p className="mt-4 text-sm font-semibold text-navy">{course.fee}</p>
                  <div className="mt-5 flex gap-3">
                    <Link href={`/courses/${course.slug}`} className="btn-primary !px-4 !py-2 text-sm">
                      課程詳情
                    </Link>
                    <Link
